...
import WithImageBG from "./inputs/WithImageBG";
  ...
  const BaseInputComponent = (
    <BaseInput
      ...
      style={[
        ...
        props.type?.includes("WithBgImage") && styles.code,
      ]}
    ...
    <View>
      {props.type !== "detailsCell" && props.type !== "displayLookup" && (
        <View style={styles.formGroup}>
          ...
          {props.type?.includes("WithBgImage") ? (
            <WithImageBG>{BaseInputComponent}</WithImageBG>
          ) : (
            BaseInputComponent
          )}
